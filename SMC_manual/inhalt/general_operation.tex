...
The settings menu contains several submenus that allow the user to adjust some of the settings right at the device itself.

Turning the rotary encoder serves to scroll through the settings menus (see figure~\ref{settings_menu}). Pressing the rotary encoder enters the selected settings menu. Pressing the menu-escape-button leaves the settings menu.
