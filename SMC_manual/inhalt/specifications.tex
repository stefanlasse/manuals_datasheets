...
\begin{table}[htbp]
  \label{specs}
  \caption[Specifications of the \productNumber .]{Specifications of the \productNumber ~\productName . With $V_{\textrm{Supply}}=\unit[24]{VDC}, $ $T_A = \unit[25]{^{\circ}C}$ and 50\% RH unless otherwise noted.}
  \centering
