...
\documentclass[a4paper, final, 12pt, twoside]{refart}
...
\fancyhead[CE,CO]{\footnotesize{\scshape{\nouppercase{\leftmark}}}}
...
%\input{../general/title_black}
\input{../general/title_white}
%\clearpage
%\cleardoublepage
