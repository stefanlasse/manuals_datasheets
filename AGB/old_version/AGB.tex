...
% General Settings
%------------------
\def \docTitle      {Allgemeine Verkaufsbedingungen (AGB)}
\def \docSubTitle   {}
\def \productNumber {}
\def \productName   {}
...
\noindent
2. Die Zahlung des Kaufpreises hat ausschließlich auf das auf der Rechnung
genannte Konto zu erfolgen. Der Abzug von Skonto ist nur bei schriftlicher
besonderer Vereinbarung zulässig.

\noindent
3. Sofern nichts anderes vereinbart wird, ist der Kaufpreis innerhalb von
